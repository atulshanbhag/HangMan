...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "hangman.py"
 
        #Name of program
        self.project_name = "hangman"
        ...
        self.license = "hangman License"
 
        #Auhor of program
        self.author_name = "tRoJaN"
        self.author_email = "shanbhag1996@gmail.com"
        self.copyright = "Copyright (c) 2016 tRoJaN."
 
        #Description
        self.project_description = "hangman Description"
